...
# Ensure keys exist before loading them
...
def create_access_token(data: dict, expires_delta: timedelta = timedelta(hours=24)) -> str:
    """
    Generate an RS256 JWT access token.
    
    :param data: The payload dictionary to encode.
    :param expires_delta: Time until the token expires. Default 24 hours.
