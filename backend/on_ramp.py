...
class IndodaxClient:
    ...
    def get_balance(self, currency: str) -> float:
        """Mengambil saldo spesifik koin atau Rupiah secara dinamis."""
        payload = {
            'method': 'getInfo',
        ...
        try:
            ...
            if data.get('success') == 1:
                ...
                # Menangani inkonsistensi penamaan key IDR/ID dari Indodax
    ...
    def get_current_price(self, pair: str) -> int:
        """Cek harga jual terendah saat ini."""
    ...
    def withdraw_asset(self, currency: str, amount: float, request_id: str, address: str, memo: str = "") -> dict:
        """Mengirimkan aset crypto ke dompet spesifik."""
        if not address:
...
if __name__ == "__main__":
    # --- 1. INISIALISASI ENVIRONMENT & KONFIGURASI UTAMA ---
    load_dotenv()
    ...
    # --- 2. CEK SALDO RUPIAH SEBELUM TRANSAKSI ---
    ...
    if current_balance < target_spend_idr:
        ...
        if current_ask_price > 0:
            ...
            # --- 4. VALIDASI PEMBELIAN & SETTLEMENT ---
            if hasil_trade.get("success") == 1:
                ...
                # Cek saldo dengan polling untuk memberi waktu matching engine Indodax
                max_retries = 10
                ...
                if actual_xlm_balance > 0:
                    ...
                    if DO_WITHDRAW:
                        ...
                        hasil_wd = client.withdraw_asset(
                            currency='xlm',
                            amount=actual_xlm_balance, # Menarik saldo yang benar-benar tersedia
