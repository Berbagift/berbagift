...
export function BalanceHeaderCard({
  ...
  return (
    <div className={cn("border border-neutral-5 rounded-md p-5 bg-white flex items-center justify-between shadow-[0_2px_8px_-2px_rgba(0,0,0,0.02)]", className)}>
      <div className="flex flex-col gap-1">
        ...
        <div className="flex items-baseline md:items-center gap-2 md:gap-3 flex-wrap">
          <h2 className="text-2xl md:text-3xl font-semibold text-black tracking-tight leading-none">
      ...
      <button
        ...
        className="flex items-center gap-1.5 border border-neutral-5 rounded-md px-3 py-1.5 hover:bg-neutral-2 active:bg-neutral-3 transition-colors text-[13px] font-medium text-black shrink-0 cursor-pointer"
      >
