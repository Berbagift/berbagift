...
export function EnvelopeSelector() {
  ...
  return (
    <div className="border border-neutral-5 rounded-md p-6 bg-white flex flex-col gap-6">
      {/* Tabs */}
      <div className="flex items-center bg-white border border-neutral-5 rounded-md">
        <button
          ...
          className={cn(
            ...
            state.uploadMode === 'preset' 
              ? "text-[#16a34a]" 
              : "text-neutral-6 hover:text-black hover:bg-neutral-50"
          )}
        >
