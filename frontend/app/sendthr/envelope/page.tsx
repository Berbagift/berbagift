  ...
  return (
    <div className="w-full flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      ...
      <div className="flex items-center justify-end gap-3 mt-4">
        <button
          onClick={() => router.back()}
          className="px-5 py-2.5 rounded-md border border-border text-black dark:text-neutral-1 font-medium text-sm hover:bg-neutral-2 transition-colors flex items-center gap-2"
        >
