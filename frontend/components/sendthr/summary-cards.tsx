...
export function SummaryCards() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      {/* Recipient Card */}
      <div className="border border-border rounded-md p-4 bg-white dark:bg-card flex flex-col gap-2">
          ...
          {primaryRecipient ? (
            <>
              ...
              {additionalRecipientsCount > 0 && (
                <div className="h-7 px-2 rounded-full border border-border bg-neutral-2 flex items-center justify-center text-xs font-medium text-neutral-8">
