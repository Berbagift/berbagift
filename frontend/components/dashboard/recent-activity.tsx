  ...
  return (
    <div className="border border-border rounded-md p-5 bg-card space-y-5">
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-black dark:text-neutral-1 border border-border rounded-md hover:bg-neutral-5/50 transition-colors">
