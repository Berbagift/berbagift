...
export function ActivityRow({
  ...
  return (
    <>
      {/* Mobile Layout */}
      <div className={cn("flex flex-col md:hidden gap-3 py-4 px-4 text-sm", !isLast && "border-b border-border")}>
        {/* Top Mobile Row */}
      ...
      {/* Desktop Layout */}
      <div className={cn("hidden md:grid grid-cols-5 items-center gap-4 py-4 px-4 text-sm", !isLast && "border-b border-border")}>
